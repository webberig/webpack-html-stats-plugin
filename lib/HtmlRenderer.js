...
module.exports = class HtmlRenderer {
    ...
    generate(context) {
        ...
        const promises = [
            ...
            this.renderPage('chunks.html.twig', 'chunks.html', context),
            this.renderPage('modules.html.twig', 'modules.html', context),
            this.renderPage('assets.html.twig', 'assets.html', { context }),
        ];
        ...
        promises.push(new Promise((resolve, reject) => {
            fs.writeFile(path.join(this.targetDir, 'stats.json'), JSON.stringify(context, null, 4), (error) => {
                if (error) {
                    return reject(error);
                }
                return resolve();
